...
module.exports = function(){
	...
	TerrainDestroyer.draw = function(){
		...
		//Check CharacterCollider if the following is confusing
		...
		var imgData = terrain.components.renderer.canvas.context.getImageData(0,0,window.innerWidth, window.innerHeight);
