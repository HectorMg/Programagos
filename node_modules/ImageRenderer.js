...
module.exports = function(imagePath, zIndex, blendMode){
	...
	ImageRenderer.canvas.setZIndex(zIndex || -1);
	ImageRenderer.canvas.setBlendMode(blendMode || "normal");
