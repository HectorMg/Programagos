	...
	SpellBall.update = function(deltaTime){
		...
		if(this.isScript){
			if(this.targets.length > 0){
				...
				if(this.targets[0].subtract(this.components.transform.position, true).magnitude() > 10){
					...
					console.log("new position: "+ this.components.transform.localPosition.x);
				}else{
