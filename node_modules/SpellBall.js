...
module.exports = function(){
	var SpellBall = new Composition(
		...
		'rigidbody', Rigidbody(),
		'renderer', VertexRenderer(new Vertices(Circle(10,10)),-5),
		'glow', VertexRenderer(new Vertices(Circle(15,15)),3,"hard-light"),
	...
	SpellBall.draw = function(){
		...
		grd.addColorStop(0.5+0.05*Math.cos(window.performance.now()*0.01),"rgba(0, 234, 230, 0.75)");
