...
module.exports = function(x, y, path){
	...
	player.castSpell = function(initVel){
		...
		this.components.spell.components.transform.localPosition = this.components.RadialSlider.components.handle.components.transform.position.clone();
	...
	player.update = function(deltaTime){
		...
		if(shouldCount && timeClicked < 2){
			...
			this.components.RadialSlider.radius = 50 +  (timeClicked * 25);
			// console.log("" + this.components.RadialSlider.radius);
		}
	}
