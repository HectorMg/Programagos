...
module.exports = function(){
	var sky = new Composition(
		...
		"renderer", VertexRenderer(null,-6),
		"foreground", VertexRenderer(null, -2, "multiply")
	);
	...
	sky.update = function(){
		...
		this.components.foreground.fillStyle = "rgba(74,36,54,"+(0.4-0.4*Math.cos(engine.time*0.0001))+")";
