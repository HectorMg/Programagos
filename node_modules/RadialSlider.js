...
module.exports = function(){
	...
	RadialSlider.start = function(){
		...
		this.components.handle.components.renderer.fillStyle = "#FFF";
	...
	RadialSlider.mousedrag = function(x,y){
		...
		if(this.components.handle!=undefined){
