...
module.exports = function(){
	...
	CharacterCollider.update = function(){
		...
		var terrainHeightAtX = getTerrainHeight(this.base.transform.position.x, this.base.transform.position.y+this.base.renderer.image.height);

		if(terrainHeightAtX==-1){
...
var getTerrainHeight = function(x, y){
	...
	if(imgData.data[Math.ceil(x)*4+3200*Math.ceil(y)+3]!=0){
		for(var i = Math.ceil(x)*4+3200*Math.ceil(y); i > 0; i-=3200){
