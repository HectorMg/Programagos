...
module.exports = function(){
	...
	CharacterCollider.update = function(){
		...
		if(terrainHeightAtX < this.base.transform.localPosition.y + this.base.renderer.image.height){
			//Set this.base.rigidbody.speed.y to 0 so it stops falling.
			this.base.rigidbody.speed.zero(0);
			//Set acceleration to 0 so it stops falling.
			//This should be done inside a gravity component that checks whether something is grounded or not.
			//Ex code: this.isGrounded = true;
			this.base.rigidbody.acceleration.zero(0);

			//Set object to be on top of terrain.
			this.base.transform.localPosition.y = terrainHeightAtX-this.base.renderer.image.height;
		}

		//Give gravity back to the player if its not grounded
		//This should be done inside a gravity component that checks whether something is grounded or not.
		//Ex code: this.isGrounded = false;
		this.base.rigidbody.acceleration.y = 100;
	}
