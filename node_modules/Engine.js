...
module.exports = (function(){
	...
	function Engine(mainComposition){
		...
		//public property time can be accesed by calling engine.time.
		//Read-Only, change at your own risk.
		this.time = 0;
		...
		function frame(){
			...
			self.time = window.performance.now();

			//Get time difference
			var timeDelta = self.time-pastTime;

			//Call update => clear window => call draw


			self.level._update(timeDelta*0.001);
			self.level._draw(timeDelta*0.001);
