...
module.exports = function(){
  var LifeBar = new Composition(
    ...
    'rendererBack', VertexRenderer(new Vertices(rectangle(new Vec2(-20, -5), new Vec2(20, 5))), -1),
    'rendererFront', VertexRenderer(new Vertices(rectangle(new Vec2(-17, -3), new Vec2(17, 3))), 0)
  );
