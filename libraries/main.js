...
window.onload = function(){
	...
	document.getElementById("editor").onclick = function(){
		global.engine.find("editorOpener").open();
	}
	...
	document.getElementById("save-spell").onclick = function(){
		console.log("first");
		var spellName = document.getElementById("spell-name").value;
		var spellCode = document.getElementById("console").value;
		...
		data.players[playerIndex].spells[spellName] = spellCode;
		console.log("second");
